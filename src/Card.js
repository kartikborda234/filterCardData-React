...
const Card = () => {
    ...
    const handleAllRemove = () => {
        setRemoveCard([])
        setCardData([...cardData,...removeCard])
        if (query){
             const searchList = removeCard.filter((item) => {
                return item.name.toLowerCase().includes(query.toLowerCase());
            })
            setFilterCard(searchList)
        }else {
            ...
            <div className="container mt-5">
                <div className='row'>
                    ...
                    <div className="col-sm-6 mt-5">
                        <button className="btn btn-primary" onClick={handleAllApply}>All apply</button>
                    </div>
                    <div className="col-sm-6 mt-5">
                        <button className="btn btn-primary" onClick={handleAllRemove}>All remove</button>
                    </div>
                    <div className="col-sm-6 mt-5">
                        {
